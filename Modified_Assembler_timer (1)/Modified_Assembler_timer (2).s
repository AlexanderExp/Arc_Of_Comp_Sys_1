...
task:
	...
	mov	r12d, 0 # Объявление переменной j, лежащей на -4 позиции, присвоение j значения 0
	mov	r12d, 0 # Объявление переменной i, лежащей на -8 позиции, присвоение i значения 0
